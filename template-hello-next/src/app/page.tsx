...
export default function Home() {
    ...
    const mpcLargest = useCallback(
        async (value: number) => {
            ...
            if (output === null || typeof output !== "object" || typeof output.main !== "number") {
                ...
                {step === 1 && (
                    <div className={styles.step}>
                        ...
                        <div style={{ textAlign: "left", marginTop: "1em" }}>
                            To start, one party should click host. This will generate a code that the other party can
                            use to join. It's an end-to-end encrypted P2P connection. There is no server.
                        </div>
                        <div style={{ textAlign: "left", marginTop: "1em" }}>
                            Once connected, both parties will enter a number and the larger number will be calculated.
                            The smaller number is kept cryptographically secret.
                        </div>
                        <div style={{ textAlign: "left", marginTop: "1em" }}>
                            This is just a simple example, but mpc-framework makes it easy to do this with any function.
                        </div>
                        <div>
                ...
                {step === 2.2 && (
                    <div className="step">
                        <div>
                            ...
                            <input onChange={(event) => setJoiningCode(event.target.value)} type="text" />
                        </div>
                        <div>
                ...
                {step === 3 && (
                    <div className="step">
                        <div>
                            ...
                            <input onChange={(event) => setNumber(parseInt(event.target.value))} type="number" />
                        </div>
                        <div>
